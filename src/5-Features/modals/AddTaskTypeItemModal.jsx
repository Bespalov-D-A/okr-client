import { useAddTaskListItemModal, useAddTaskModal, useAddTaskTypeItemModal, useLoginModal } from "../../6-Entities/modals";
...
const AddTaskTypeItemModal = ({ component }) => {
	...
	const setBtnDisabled = useAddTaskTypeItemModal((state) => state.setBtnDisabled);
