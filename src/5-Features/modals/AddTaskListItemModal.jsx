import { useAddTaskListItemModal, useAddTaskModal, useLoginModal } from "../../6-Entities/modals";
...
const AddTaskListItemModal = ({ component }) => {
	...
	const setBtnDisabled = useAddTaskListItemModal((state) => state.setBtnDisabled);
